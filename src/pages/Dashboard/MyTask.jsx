...
const MyTask = () => {
  ...
  return (
    <div className="bg-[#f7f5f4] min-h-screen w-full p-2 lg:p-0"> {/* Full width background */}
      <div className="max-w-7xl mx-auto lg:mt-10 p-6 bg-white shadow-lg rounded-3xl">
              ...
              {tasks.length > 0 ? (
                tasks.map((task) => (
                  <tr key={task._id} className="text-center">
                    ...
                    <td className="p-2 space-x-2 flex flex-col lg:flex-row gap-2">
